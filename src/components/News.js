...
export class News extends Component {
    ...
    handlePreviousClick = async () =>{
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=99f25f26016f46a188d21f22c4ec9267&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
